...
export class ProxyNodeClient {
    ...
    update(proxyNodeId: string, proxyNode: ProxyNode, cancelToken?: CancelToken): Promise<AppProxyNodeInfo> {
        ...
        if (proxyNodeId === undefined || proxyNodeId === null)
            throw new Error("The parameter 'proxyNodeId' must be defined.");
    ...
    import(text: string, removeOld: boolean, cancelToken?: CancelToken): Promise<void> {
        ...
        if (removeOld === undefined || removeOld === null)
            throw new Error("The parameter 'removeOld' must be defined and cannot be null.");
        else
...
export class AppFeatures implements IAppFeatures {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.webUiPort = _data["webUiPort"] !== undefined ? _data["webUiPort"] : <any>null;
    ...
    toJSON(data?: any) {
        ...
        data["webUiPort"] = this.webUiPort !== undefined ? this.webUiPort : <any>null;
...
export class ProxyNodeInfo implements IProxyNodeInfo {
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["node"] = this.node ? this.node.toJSON() : <any>null;
...
export class ProxyNodeStatus implements IProxyNodeStatus {
    ...
    init(_data?: any) {
        if (_data) {
            this.penalty = _data["penalty"] !== undefined ? _data["penalty"] : <any>null;
            this.succeededCount = _data["succeededCount"] !== undefined ? _data["succeededCount"] : <any>null;
            this.failedCount = _data["failedCount"] !== undefined ? _data["failedCount"] : <any>null;
            this.latency = _data["latency"] !== undefined ? _data["latency"] : <any>null;
            this.lastUsedTime = _data["lastUsedTime"] ? new Date(_data["lastUsedTime"].toString()) : <any>null;
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["penalty"] = this.penalty !== undefined ? this.penalty : <any>null;
        data["succeededCount"] = this.succeededCount !== undefined ? this.succeededCount : <any>null;
        data["failedCount"] = this.failedCount !== undefined ? this.failedCount : <any>null;
        data["latency"] = this.latency !== undefined ? this.latency : <any>null;
        data["lastUsedTime"] = this.lastUsedTime ? this.lastUsedTime.toISOString() : <any>null;
