...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'PRIVATE_DNS': RouteRecordInfo<'PRIVATE_DNS', '/settings/private-dns', Record<never, never>, Record<never, never>>,
    'PRIVATE_DNS_ERROR': RouteRecordInfo<'PRIVATE_DNS_ERROR', '/settings/private-dns/private-dns-error', Record<never, never>, Record<never, never>>,
    'TURN_OFF_PRIVATE_DNS': RouteRecordInfo<'TURN_OFF_PRIVATE_DNS', '/settings/private-dns/turn-off-private-dns', Record<never, never>, Record<never, never>>,
