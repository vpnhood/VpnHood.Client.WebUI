...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'SPLIT_IPS_VIA_APP': RouteRecordInfo<'SPLIT_IPS_VIA_APP', '/split-tunneling/split-ips-using-app', Record<never, never>, Record<never, never>>,
    'SPLIT_IPS_VIA_DEVICE': RouteRecordInfo<'SPLIT_IPS_VIA_DEVICE', '/split-tunneling/split-ips-using-device', Record<never, never>, Record<never, never>>,
