...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'FREE_SERVERS_DISRUPTIONS': RouteRecordInfo<'FREE_SERVERS_DISRUPTIONS', '/learn-more/free-servers-disruptions', Record<never, never>, Record<never, never>>,
    'PRIVACY_POLICY': RouteRecordInfo<'PRIVACY_POLICY', '/privacy-policy', Record<never, never>, Record<never, never>>,
    'PROMOTE_PREMIUM': RouteRecordInfo<'PROMOTE_PREMIUM', '/promote-premium', Record<never, never>, Record<never, never>>,
    ...
    'PROXIES': RouteRecordInfo<'PROXIES', '/settings/proxies', Record<never, never>, Record<never, never>>,
    ...
    'SPLIT_APPS': RouteRecordInfo<'SPLIT_APPS', '/split-tunneling/split-apps', Record<never, never>, Record<never, never>>,
    'SPLIT_COUNTRIES': RouteRecordInfo<'SPLIT_COUNTRIES', '/split-tunneling/split-countries', Record<never, never>, Record<never, never>>,
    'SPLIT_DOMAINS': RouteRecordInfo<'SPLIT_DOMAINS', '/split-tunneling/split-domains', Record<never, never>, Record<never, never>>,
    'SPLIT_IPS_VIA_APP': RouteRecordInfo<'SPLIT_IPS_VIA_APP', '/split-tunneling/split-ips-via-app', Record<never, never>, Record<never, never>>,
    'SPLIT_IPS_VIA_DEVICE': RouteRecordInfo<'SPLIT_IPS_VIA_DEVICE', '/split-tunneling/split-ips-via-device', Record<never, never>, Record<never, never>>,
